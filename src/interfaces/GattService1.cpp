...
GattService1::GattService1(std::shared_ptr<SimpleDBus::Connection> conn, std::string path) : _conn(conn), _path(path), Properties{conn, "org.bluez", path}, PropertyHandler(path) {
